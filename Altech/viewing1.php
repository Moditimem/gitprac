...
<html>
	...
	<h3 align="center" style="color:#0B2161; font-family:Tahoma" >Previously Captured Members</h3>
                </br>
                ...
                <?php
				        ...
				        if ($result = $mysqli->query("SELECT * FROM Telesave.Members  where Load_By='Melissa Pillay' GROUP BY Member.Load_Date ASC" ))
				        {
				        	...
				        	if ($result->num_rows != 0)
				        	{
						        ...
						        for ($i = $start; $i < $end; $i++)
						        {
					                ...
					                echo '<td><font face="Tahoma"><a href="editing.php?id=' . $row[0] . '">Edit</a></font></td>';
					                echo "</tr>";
				...
				<strong><font face='Tahoma'> <?php echo"Hi! <p style='color:FireBrick; font-family:Tahoma'>"  .$_SESSION['name'].' </p> You have  Registered '.$_SESSION['count2']. " record (s) in total"?></font></strong></br></br>
